...
Welcome to my page! This is Tianzhong Lan, a fourth-year Ph.D. candidate in the College of Computer Science, Sichuan University, under the supervision of Prof. [Min Zhu](http://scuvis.org) and Prof. [Zhang Yi](http://www.machineilab.org/users/zhangyi/index.html). I have been awarded the Chinese CSC scholarship to pursue research at the A*STAR in Singapore from July 2025 to July 2026, under the supervision of Principal Scientists [Xulei Yang](https://dawdleryang.github.io) and [Feng Yang](https://scholar.google.com/citations?user=i-UD9l4AAAAJ&hl=zh-CN&oi=ao).
